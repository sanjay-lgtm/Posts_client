...
const navigation = [
  { name: 'Posts', to: '/posts', current: true },
  { name: 'Chats', to: '/chats', current: false },
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              <Link to='/'>
                <img
                  alt="Your Company"
                  src="https://www.svgrepo.com/show/11574/diary.svg"
              ...
              <Link to={ '/signup' }>
                <div>
                  <Menu.Button className="relative flex rounded-full bg-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-100">
                    ...
                    <FaUserLock aria-hidden="true" className="h-7 w-7" />
                  </Menu.Button>
                </div>
